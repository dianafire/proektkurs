...
CREATE TABLE `students` (
  ...
  `personalIDNum` varchar(45) NOT NULL,
  PRIMARY KEY (`studentID`),
  UNIQUE KEY `personalIDNum_UNIQUE` (`personalIDNum`),
  KEY `fk_classes_classID_idx` (`classID`),
  CONSTRAINT `fk_classes_classID` FOREIGN KEY (`classID`) REFERENCES `classes` (`classID`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `students_courses` (
  ...
  KEY `fk_courses_courseID_idx` (`courseID`),
...
CREATE TABLE `teachers` (
  ...
  CONSTRAINT `fk_courses_courseID` FOREIGN KEY (`ID`) REFERENCES `courses` (`courseID`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-05-29  7:42:00
